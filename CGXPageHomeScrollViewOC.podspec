...
s.description  = "(CGXPageHomeScrollViewOC基于UITableView封装的顶部悬停等主流APP个人中心页的库"  #描述
...
s.source       = { :git => "https://github.com/974794055/CGXPageHomeScrollView-OC.git", :tag => s.version }         #存储库的git地址，以及tag值
