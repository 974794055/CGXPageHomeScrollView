...
static NSString *const CGXPageHomeSmoothViewCellID = @"smoothViewCell";
...
@interface CGXPageHomeSmoothView()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate>

@property (nonatomic, weak) id<CGXPageHomeSmoothViewDataSource> dataSource;
...
@implementation CGXPageHomeSmoothView

- (instancetype)initWithDataSource:(id<CGXPageHomeSmoothViewDataSource>)dataSource {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CGXPageHomeSmoothViewCellID forIndexPath:indexPath];
...
- (UICollectionView *)listCollectionView {
    if (!_listCollectionView) {
        ...
        [_listCollectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:CGXPageHomeSmoothViewCellID];
        if (@available(iOS 11.0, *)) {
