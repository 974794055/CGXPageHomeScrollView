...
@protocol CGXPageHomeSmoothViewDataSource <NSObject>
...
@protocol CGXPageHomeSmoothViewDelegate <NSObject>

@optional
/// 列表容器滑动代理
/// @param smoothView smoothView
/// @param scrollView containerScrollView
- (void)smoothView:(CGXPageHomeSmoothView *)smoothView scrollViewDidScroll:(UIScrollView *)scrollView;
...
@interface CGXPageHomeSmoothView : UIView

/// 代理
@property (nonatomic, weak) id<CGXPageHomeSmoothViewDelegate> delegate;
...
- (instancetype)initWithDataSource:(id<CGXPageHomeSmoothViewDataSource>)dataSource NS_DESIGNATED_INITIALIZER;
